...
### 1. Метод TrackingBox - Инициализирует объект трекера с заданными координатами и размерами, а также уникальным идентификатором. 
    ...
    - 1.3 Алгоритм: 
       - Конструктор создает объект TrackingBox с заданными координатами и размерами. Уникальный ID объекта автоматически увеличивается с помощью статического счетчика id_counter.
