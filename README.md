...
## TrackingBox.cpp - Класс TrackingBox предназначен для реализации системы отслеживания объектов на видео или в последовательности изображений. Он создает и обновляет трекеры для обнаруженных объектов, используя методы сопоставления, такие как IoU (Intersection over Union) и венгерский алгоритм для оптимизации соответствий между трекерами и обнаруженными объектами. Класс также управляет гистограммами, которые используются для определения схожести объектов.
